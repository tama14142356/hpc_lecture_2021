...
GHOME="/work/jh160041a/g27030/work_dir"
...
# mpirun -machinefile $PJM_O_NODEINF -np 16 -npernode 8 -x NCCL_BUFFSIZE=1048576 python 12_distributed.py
# mpiexec \
mpirun \
